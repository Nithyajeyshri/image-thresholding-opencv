...
if img is None:
    ...
    plt.show()
```
![alt text](<Screenshot 2026-08-30 174416.png>)

#### Original Grayscale Image
```
import cv2
import matplotlib.pyplot as plt
img = cv2.imread("event.jpg", cv2.IMREAD_GRAYSCALE)
plt.imshow(img, cmap="gray")
plt.title("Original Grayscale Image")
plt.axis("off")
plt.show()
```
![alt text](<Screenshot 2026-08-30 174422.png>)
...
plt.show()
```
![alt text](<Screenshot 2026-08-30 174427.png>)
...
plt.show()
```
![alt text](<Screenshot 2026-08-30 174433.png>)
...
plt.show()
```
![alt text](<Screenshot 2026-08-30 174439-1.png>)
